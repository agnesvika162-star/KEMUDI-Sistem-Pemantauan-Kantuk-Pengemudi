function WarningBox({ status }) {
  ...
  return (
    <div
      className={`rounded-3xl border-[4px] md:border-[5px] p-4 md:p-6 transition-all duration-300 h-full
      ${
        isDrowsy ? "bg-red-50 border-red-600" : "bg-green-50 border-green-600"
      }`}
    >
      <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6 h-full text-center md:text-left">
        {/* ICON */}
        <div className="flex-shrink-0">
          ...
          >
            <span className="text-[110px] md:text-[185px] leading-none md:-translate-y-4">
              {isDrowsy ? "⚠" : "☺"}
            </span>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-hidden">
          {/* TITLE */}
          <h1
            className={`text-3xl md:text-5xl font-black leading-none tracking-wide mb-4
